...
# Run collectstatic with Django settings
ENV DJANGO_SETTINGS_MODULE=dalal_project.settings
RUN python manage.py collectstatic --noinput --clear
RUN echo "Static files collected to staticfiles: $(ls -la /app/staticfiles/)"
